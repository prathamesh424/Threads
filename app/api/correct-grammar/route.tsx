...
export async function POST(req: NextRequest) {
  try {
    ...
    const prompt = `Correct the grammar and spelling in the following text in ${language} language and only return the corrected text without any other text or code blocks:
    "${thread}"`;
