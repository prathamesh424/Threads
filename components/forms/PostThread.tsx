...
const handleAutoPostGeneration = async () => {
  try {
    const currentText = form.getValues("thread");
    const language = "en-US"; 
    ...
    <Form {...form}>
      ...
      >
        <FormItem className="flex w-full flex-col gap-3">
          ...
          <FormControl className="no-focus border border-color4 bg-color2 text-primary_text">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex w-full flex-col gap-3">
              ...
              <FormControl className="no-focus border border-color4 bg-color2 text-primary_text">
                <Textarea placeholder="Enter the detailed description or prompt to generate post ....." rows={15} {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <div className="flex gap-4">
          ...
          <Button type="button" onClick={handleAutoPostGeneration} className="bg-secondary-500">
           Auto Generate
          </Button>
